...
Izh |$$\frac{dv}{dt} = \left(0.04 \, \frac{1}{\text{ms} \cdot \text{mV}}\right)v^2 + \left(5 \, \frac{1}{\text{ms}}\right)v + 140 \,\frac{\text{mV}}{\text{ms}} - u + I \quad : \text{volt}\$$   $$\frac{du}{dt} = a \left(bv - u\right) \quad : \text{volt/second}\$$ | a, b, d, vr
