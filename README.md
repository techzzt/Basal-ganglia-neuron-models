...
QIF | $$\frac{dv}{dt} = \frac{k \cdot 1 \, \text{pF/ms/mV} \cdot (v - v_r) \cdot (v - v_t) - u \, \text{pF} + I}{C}$$ $$\frac{du}{dt} = a \cdot \left(b \cdot (v - v_r) - u\right)$$ | g_L, Delta_T, E_L, v, vr, vt, tau_w, a, d, C 
