...
class GPe_STN_inh_ext_dop_dep(SynapseBase):
    ...
    def create_synapse(self):
        ...
        syn_Cortex_FSN.w = 1
        syn_Cortex_FSN.ampa_beta = self._get_param('ampa_beta')
        ...
        syn_Cortex_MSND1_ampa.ampa_beta = self._get_param('ampa_beta')
        ...
        syn_Cortex_MSND1_nmda.nmda_beta = self._get_param('nmda_beta')
        ...
        syn_Cortex_MSND2_ampa.ampa_beta = self._get_param('ampa_beta')
        ...
        syn_Cortex_MSND2_nmda.nmda_beta = self._get_param('nmda_beta')
        ...
        syn_Cortex_STN_ampa.ampa_beta = self._get_param('ampa_beta')
        ...
        syn_Cortex_STN_nmda.nmda_beta = self._get_param('nmda_beta')
